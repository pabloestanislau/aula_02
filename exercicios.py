...
#print("Nome em minúsculas:", nome_minuscula)

# 13. Desenvolva um programa que peça ao usuário para inserir uma frase e, em seguida, imprima esta frase sem espaços em branco no início e no fina
#frase = input("Digite uma frase: ")
#frase_sem_espacos = frase.strip()
#print("Frase sem espaços no inicio e no final:", frase_sem_espacos)
...
#valor2 = input("Digte o segundo valor booleando (True ou false): ")
#resultado_and = valor1 and valor2
#print("Resultado do AND lógico:", resultado_and)

# 17. Crie um programa que receba dois valores booleanos do usuário e retorne o resultado da operação OR.
# valor1 = input("Digite o primeiro valor (True ou False): ")
# valor2 = input("Digite o seguno valor (True ou False): ")
